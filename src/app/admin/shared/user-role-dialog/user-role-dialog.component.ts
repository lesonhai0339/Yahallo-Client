...
@Component({
  ...
  styles: [`
    .role-dialog { padding: 4px; min-width: 340px; color: var(--text-primary); }
    ...
    .role-chip { display: inline-flex; align-items: center; gap: 6px; background: rgba(233,69,96,0.08); border: 1px solid rgba(233,69,96,0.25); color: var(--accent-primary); padding: 4px 10px; border-radius: 20px; font-size: 0.78rem; font-weight: 500; }
